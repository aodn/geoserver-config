...
<h3>Seagrass sampling - Cockburn Sound</h3> 
...
title="http://bluenet.aodn.org.au/geonetwork/srv/en/metadata.show?uuid=${feature.metadata_uuid.value}">Data metadata record</a><BR>
