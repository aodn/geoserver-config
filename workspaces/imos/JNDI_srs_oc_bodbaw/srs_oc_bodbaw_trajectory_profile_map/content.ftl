...
<a  rel="external" href="${my.baseurlThredds}/thredds/fileServer/IMOS/${feature.url_nc.value?substring(feature.url_nc.value?last_index_of("opendap")+7, feature.url_nc.value?last_index_of(".") + 3)}" target="_blank" class="h3" >Download Deployment as NetCDF</a><BR>
