...
<#if feature.DEPTH.value != "0.0" >${feature.DEPTH.value}m</#if> ${feature.time_end.value?date}
</option>
</#list>
</select>
...
<!--a href="http://data.aims.gov.au/gbroosdata/services/rss/latestData/${feature.channel_id.value}"  target="_blank"  rel="external" >RSS</a-->
