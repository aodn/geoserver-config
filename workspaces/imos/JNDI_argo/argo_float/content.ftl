...
<h3>Argo Floats in Australia's region of interest</h3>
...
<br>
<a href="" onclick="setExtWmsLayer('${my.baseurl}/geoserver/wms','Argo Track ${feature.platform_number.value}','1.1.1','float_cycle_vw','','float_id = ${featureId}','');return false;">Add Argo Track to map</a><BR>
