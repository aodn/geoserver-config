...
<div class="featurewhite">
 ...
 <a rel="external" href="${my.baseurlDataServerS3Listing}IMOS/SOOP/SOOP-BA/${feature.platform_code.value}_${feature.vessel_name.value?replace(" ","-")}/" target="_blank"> View more echograms from the ${feature.vessel_name.value}</a>
</div>
</#if>
</#list>
</div>
