...
<#assign image = "${my.baseurlDataServerS3}/AUV/IMOS/auv_viewer_data/thumbnails/${feature.campaign_code.value}/${feature.site_code.value}/i2jpg/${feature.image_filename.value}.jpg" >
