...
<#assign image = "${my.baseurlDataServerS3}/IMOS/AUV/auv_viewer_data/thumbnails/${feature.campaign_code.value}/${feature.site_code.value}/i2jpg/${feature.image_filename.value}.jpg" >

<div class="panel"  id="auvpanel_${feature_index}" >
<a href="#" onclick="openPopup('${image}','${my.baseurlDataServerS3}/IMOS/AUV/${feature.campaign_code.value}/${feature.site_code.value}/${feature.image_folder.value}/${feature.image_filename.value}.tif');return false;" >
<img src="${image}" />
</a>
