...
<h3>SOOP CPR Zooplankton Abundance Survey </h3>
...
<#list features as feature>
    ...
    <div class="feature">
        ...
        <br/>Zooplankton Abundance: <b>${feature.taxon_per_m3.value}</b>
        <br/>Taxon Name: <b>${feature.taxon_name.value}</b>
        <br/>Taxon Group: <b>${feature.taxon_group.value}</b>
        <br/>Taxon Sub Group: <b>${feature.taxon_eco_group.value}</b>
        <br/>Comments: <b>${feature.zoop_comments.value}</b>
    </div>
