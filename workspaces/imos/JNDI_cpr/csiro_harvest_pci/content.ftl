...
<#list features as feature>
    ...
    <#if (feature_index < 1) >
        ...
        <p>Transect ID:
            ...
            <a  rel="external" 
                href="http://geoserver.imos.org.au/geoserver/wfs?service=wfs&version=1.1.0&request=GetFeature&typeName=imos:csiro_harvest_pci&srs=EPSG:4326&outputFormat=csv&cql_filter=(route_code='${feature.route_code.value}')"
