...
<b>The product aggregates data collected at the following nominal depth:</b> ${feature.instrument_nominal_depth.value}</br>
<b>over the period :</b> ${feature.time_coverage_start.value} - ${feature.time_coverage_end.value}</br>
