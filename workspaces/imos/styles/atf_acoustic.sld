        ...
        <UserStyle>
            ...
            <FeatureTypeStyle>
                ...
                <Rule>
                    ...
                    <Title>1 &lt;= x &lt; 100 (detections/station)</Title>
                    <ogc:Filter>
                        <ogc:And>
                 ...
                 <Rule>
                    ...
                    <Title>100 &lt;= x &lt; 1000 (detections/station)</Title>
                    <ogc:Filter>
                        <ogc:And>
                            <ogc:PropertyIsGreaterThanOrEqualTo>
                                <ogc:PropertyName>no_detections</ogc:PropertyName>
                ...
                <Rule>
                    ...
                    <Title>1000 &lt;= x &lt; 5000 (detections/station)</Title>
                    <ogc:Filter>
                        <ogc:And>
                            <ogc:PropertyIsGreaterThanOrEqualTo>
                                <ogc:PropertyName>no_detections</ogc:PropertyName>
                ...
                <Rule>
                  ...
                  <Title>Greater than 5000 (detections/station)</Title>
                    <ogc:Filter>
                        <ogc:PropertyIsGreaterThanOrEqualTo>
                            <ogc:PropertyName>no_detections</ogc:PropertyName>
                            <ogc:Literal>5000</ogc:Literal>
