...
<#if (feature_index < 1 & feature.device_wmo_ref.value != '') >
  <li><b>Hydrographic section for tag ${feature.device_wmo_ref.value}, as seen on the <a href="http://oceancurrent.imos.org.au/aatams.php">IMOS-OceanCurrent Seal CTD page</a></b>: <br/>
  ...
  <#elseif feature.device_wmo_ref.value == ''>
    No hydrographic section available for tag ${feature.device_wmo_ref.value}, for other transects consult the <a href="http://oceancurrent.imos.org.au/aatams.php">IMOS-OceanCurrent Seal CTD page</a>
        <#break>
</#if>
</#list>
</div>
