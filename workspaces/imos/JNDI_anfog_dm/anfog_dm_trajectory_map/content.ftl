...
<#if (feature_index < 1) >
  ...
  <b>View summary charts of this deployment: <a  rel="external" href="${my.baseurlDataServerS3Listing}IMOS/ANFOG/${glider}/${feature.deployment_name.value}/" target="_blank" class="h3" > Charts</a>
