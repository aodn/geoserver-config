...
<a href="http://data.aodn.org.au/IMOS/public/ANFOG/Realtime/${feature.platform_type.value}/${feature.deployment_name.value}" target="_blank">Summary graphs of temperature, salinity, concentration of Chlorophyll, dissolved oxygen and coloured dissolved organic matter are avaialble here</a>
<BR>
</div>
</#if>
</#list>