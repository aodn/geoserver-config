...
<#if (feature_index < 1) >
    ...
    <b>View charts of this deployment: <a  rel="external" href="${my.baseurlDataServer}/?prefix=IMOS/ANFOG/${platform}/${feature.deployment_name.value}/" target="_blank" class="h3" > Charts</a>
