...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>SOOP SST</Name>
    <UserStyle>
      <Title>SOOP SST 1minute average</Title>
      <FeatureTypeStyle>
      <Rule>
        
       <LineSymbolizer>
          <Stroke>
            <CssParameter name="stroke">#89bed6</CssParameter>
    ...
    <Rule>   
          <Name>SOOP SST Tracks (Directional Arrows)</Name> 
  ...
  <CssParameter name="stroke-dasharray">0 12 10 152</CssParameter>
        ...
        <CssParameter name="stroke-dasharray">0 18 1 155</CssParameter>
         ...
         <Rule><Name>SST file start/end points</Name> 
